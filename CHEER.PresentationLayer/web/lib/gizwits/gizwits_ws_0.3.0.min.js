...
GizwitsWS.prototype._getUserToken = function () {
    var me = this;
    var CH_userToken = JSON.parse(localStorage.getItem("CH_userToken"));
    if (CH_userToken != null) {
        // ÅÐ¶ÏtokenÊÇ·ñ¹ýÆÚ
        if (new Date(CH_userToken.expire_at) < new Date()) {
            ...
            .done(function (result) {
                localStorage.CH_userToken = JSON.stringify(result);
            ...
            me._userId = CH_userToken.uid;
            me._userToken = CH_userToken.token;
            var limit = 20;
            var skip = 0;
            me._bindingDevices = {};
            me._getBindingList(limit, skip);
